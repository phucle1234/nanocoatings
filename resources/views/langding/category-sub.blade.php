...
<div class="page-venture">
    ...
    <div class="box-category" style="background: url('{{ asset('langding/imgs/bg-avenza.png') }}') no-repeat center center; background-size: cover; border: 1px solid #c5ccd3;">
        <div class="container-fluid py-5">
            <div class="title-with-line fw-500 fs-18 text-center text-light-red">{{ __('messages.related_categories') }}</div>
            <h2 class="font-hanzel fs-32 fw-400 text-center mt-2 text-black">{{ __('messages.top_tire_manufacturer') }}</h2>

            <div class="box-category-slider mt-4">
                <div class="box-category-slider-item">
                    <div class="row justify-content-center">
                        @forelse($relatedCategories ?? [] as $relatedCategory)
                            <div class="col-md-6 col-lg-4">
                                <div class="product-item text-center">
                                    @include('langding.components.category-card-link', ['category' => $relatedCategory, 'detailVariant' => 'dark'])
                                </div>
                            </div>
                        @empty
                            <div class="col-12 text-center py-5">
                                <p class="fs-18 text-black">{{ __('messages.no_categories') }}</p>
                            </div>
                        @endforelse
                    </div>
                </div>
    ...
    <div class="product-detail-related">
        <div class="container-fluid">
            ...
            <h2 class="title-main font-hanzel fs-32 fw-400 text-center mt-2">
                {{ __('messages.latest_products', ['category' => $selectedRootCategory['name']]) }}
            </h2>
        </div>
