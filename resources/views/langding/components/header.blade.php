        ...
        <ul class="list-unstyled fw-bold">
            ...
            <li>
                <div class="d-flex justify-content-between align-items-center">
                    <a href="{{ route('about') }}" class="text-white fs-16">{{ __('messages.about_casumina') }}</a>
                    <span class="show-level-1"><i class="fas fa-chevron-right text-white"></i></span>
                </div>

                <ul class="menu-level-1 list-unstyled">
                    @if (isset($gioiThieuCasuminaPosts) && count($gioiThieuCasuminaPosts) > 0)
                    @foreach ($gioiThieuCasuminaPosts as $index => $category)
                    @php
                    ...
                    <li class="menu-item-level-1">
                        <a href="{{ $categoryUrl }}"
                            ...
                            <span class="fs-14 fw-bold d-flex align-items-center gap-2">
                                <!-- <img src="{{ asset('langding/imgs/icon-menu-' . $iconNumber . '.svg') }}" alt="icon" /> -->
