<div class="box-slider">
        <div class="bg-slider no-slider"
            style="background: url('{{ $homeSliderBanners3['category_bg_image'] ?? '' }}') no-repeat center center;background-size: cover;">
        </div>
        <div class="box-slider-head scroll-animate animated" data-animate="fadeInUp">
            ...
            @else
                <h2 class="font-hanzel fs-32 fw-400 text-center mt-2 text-white">
                    {{ $homeSliderBanners3['meta_description'] ?? 'Application Potential' }}
                </h2>
            @endif
        </div>
        ...
        <div class="main-slider">
            <div class="main-slider-items">
                @if (isset($homeSliderBanners3['banners']) && $homeSliderBanners3['banners']->count() > 0)
                    @foreach ($homeSliderBanners3['banners'] as $banner)
