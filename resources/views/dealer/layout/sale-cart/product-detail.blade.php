        ...
        <div class="mt-5 row">
            ...
            <div class="col-xl-9">
                <div class="product-detail" data-product-id="{{ $product->id }}"
                    data-url="{{ route('dealer.sale-cart.add-to-cart') }}">
                    <div class="d-flex align-items-center justify-content-between border-bottom pb-2 mb-3">
                        <h1 class="font-hanzel fs-22 fw-400 mb-0">Chi tiết sản phẩm</h1>
                        <a href="{{ route('dealer.sale-cart') }}" class="fw-500 d-flex align-items-center gap-2"><i
...
@endsection
@push('scripts')
    <script src="{{ asset('dealer/js/sale-cart/detail.js') }}"></script>
@endpush
