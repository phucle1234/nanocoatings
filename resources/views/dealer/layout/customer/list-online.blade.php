            ...
            <div class="col-xl-9">
                <ul class="status-items list-unstyled d-flex align-items-center">
                    ...
                    <li class="status-item px-4 py-2 fs-16 fw-500 border-bottom border-2 border-danger">
                        <a href="{{ route('dealer.customer-online') }}" class="text-red">
                            Online
                        </a>
                    </li>
                    <li class="status-item px-4 py-2 fs-16 fw-500">
                        <a href="{{ route('dealer.customer-offline') }}" class="text-body-tertiary opacity-50">
                            Offline
                        </a>
                    </li>
                </ul>
                ...
                <div id="customer-table-container" data-url="{{ route('dealer.customer-online') }}">
