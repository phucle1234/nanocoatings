    ...
    <table class="table table-hover">
        ...
        <tbody>
            @forelse ($list as $product)
                <tr data-product-id="{{ $product->id }}" data-url="{{ route('dealer.loan-order.add-to-cart') }}">
                    <td class="ps-0">
                        <a href="{{ route('dealer.loan-order.product-detail', ['id' => $product->id]) }}">
                    ...
                    <td class="pe-0">
                        <div class="d-flex align-items-center gap-2 justify-content-end">
                            <a href="{{ route('dealer.loan-order.product-detail', ['id' => $product->id]) }}"><i class="bi bi-eye fs-22"></i></a>
                            @if ($product->price > 0)
