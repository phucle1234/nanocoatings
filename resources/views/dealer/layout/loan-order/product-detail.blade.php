...
@section('dealer_content')
    <div class="page-order container-xl container-fluid">
        ...
        <h1 class="font-hanzel fs-42 fw-400 mt-5">MƯỢN HÀNG - CHI TIẾT SẢN PHẨM</h1>
        ...
        <div class="mt-5 row">
            ...
            <div class="col-xl-9">
                <div class="product-detail" data-product-id="{{ $product->id }}"
                    data-url="{{ route('dealer.loan-order.add-to-cart') }}">
                    <div class="d-flex align-items-center justify-content-between border-bottom pb-2 mb-3">
                        <h1 class="font-hanzel fs-22 fw-400 mb-0">Chi tiết sản phẩm</h1>
                        <a href="{{ route('dealer.loan-order') }}" class="fw-500 d-flex align-items-center gap-2"><i
                    ...
                    <div class="product-small d-flex align-items-center gap-3 mb-3">
                        ...
                        <div class="product-name fw-600">
                            ...
                            <div><span
                                    class="text-secondary bg-body-secondary fs-12 fw-500 rounded-1 px-2 py-1">{{ $product->sku }}</span>
                            </div>
                        </div>
                    </div>
...
@endsection
@push('scripts')
    <script src="{{ asset('dealer/js/loan-order/detail.js') }}"></script>
@endpush
