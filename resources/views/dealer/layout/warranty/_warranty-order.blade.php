<div class="warranty-certification">
    <div class="warranty-certification-search d-flex align-items-center gap-3">
        ...
        <span class="fw-600">Đơn hàng được tìm thấy</span>
    </div>
        ...
        <div class="row">
            <div class="col-md-3 d-flex align-items-stretch">
                <div class="p-2 d-flex align-items-center justify-content-center h-100">
                    <i class="bi bi-journal-check fs-72 text-red"></i>
                </div>
            </div>
            <div class="col-md-9">
                <div class="warranty-certification-info py-4 pe-4">
                    <p class="fs-18 fw-600 mb-1">TÊN KHÁCH HÀNG</p>
                    <h2 class="font-hanzel fs-30 text-red">{{ $warrantyInfo?->customer_name ?? 'N/A' }}</h2>
                    <div class="d-flex justify-content-between mt-4">
                        <div class="warranty-certification-status">
                            <p class="fw-600 mb-1">Mã đơn hàng</p>
                            <p class="text-red fw-600">{{ $warrantyInfo?->order_no ?? 'N/A' }}</p>

                            <p class="fw-600 mb-1">Số điện thoại</p>
                            <p class="text-red fw-600">{{ $warrantyInfo?->phone ?? 'N/A' }}</p>

                            <p class="fw-600 mb-1">Email</p>
                            <p class="text-red fw-600">{{ $warrantyInfo?->email ?? 'N/A' }}</p>

                            <p class="fw-600 mt-4 mb-1">Tình trạng bảo hành</p>
                            @if ($warrantyInfo?->status == 1)
                                <p class="text-success fw-600">Đã kích hoạt</p>
                    ...
                    <div class="d-flex align-items-center gap-3 mt-3">
                        @if ($warrantyInfo?->status == 1)
                            ...
                            <button type="button" class="btn btn-dark text-white rounded-1 px-3 py-2 fw-500" data-bs-toggle="modal" data-bs-target="#requestWarrantyModal">ĐỀ NGHỊ BẢO HÀNH</button>
                        @endif
                    </div>
                </div>
            </div>
    ...
    <div class="order-btn-link d-flex align-items-center justify-content-between gap-2 mt-5">
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <a href="{{ route('dealer.warranty') }}" class="fw-600">Tìm kiếm đơn hàng khác</a>
        </div>
    </div>
</div>
<!-- Modal -->
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content bg-img-cover"
            ...
            <div class="modal-body text-center text-white">
                ...
                <p class="fs-14 fw-500 mt-4 mb-2">Tên khách hàng: {{ $warrantyInfo?->customer_name ?? 'N/A' }}</p>
                <p class="fs-14 fw-500 mt-2 mb-2">Mã đơn hàng: {{ $warrantyInfo?->order_no ?? 'N/A' }}</p>
                <p class="fs-14 fw-500 mt-2 mb-2">Phone: {{ $warrantyInfo?->phone ?? 'N/A' }}</p>
                <p class="fs-14 fw-500 mt-2 mb-2">Email: {{ $warrantyInfo?->email ?? 'N/A' }}</p>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <h4 class="font-hanzel text-center fs-22 text-red mt-3 mb-5">ĐỀ NGHỊ BẢO HÀNH HÓA ĐƠN</h4>
                    <form method="POST" action="{{ route('dealer.warranty-request') }}">
                        ...
                        <div class="mb-3">
                            <label for="order_no" class="form-label fw-600 fs-14">
                                Số hóa đơn
                                <span class="text-danger">*</span>
                            </label>
