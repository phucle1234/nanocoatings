    ...
    <table class="table table-hover">
        <thead>
            <tr>
                ...
                <th scope="col" class="text-secondary fw-500 text-nowrap">Ngày tiếp nhận</th>
        ...
        <tbody>
            @forelse ($list as $item)
                <tr>
                    ...
                    <td class="py-4 fs-14">
                        <a href="{{ route('dealer.ecommerce-detail', ['id' => $item->id]) }}"
                    ...
                    <td class="text-end">
                        <div class="d-flex align-items-center justify-content-end gap-3">
                            <a href="{{ route('dealer.ecommerce-detail', ['id' => $item->id]) }}"><i
            ...
            @empty
                <tr>
                    <td colspan="6" class="text-center py-4">
                        <p class="fs-16 fw-500 text-secondary">Không tìm thấy đơn hàng phù hợp
                        </p>
                    </td>
                </tr>
            @endforelse
