...
@section('dealer_content')
    <div class="page-casumina container-xl container-fluid">
        ...
        <h1 class="font-hanzel fs-42 fw-400 mt-5">SỔ NHẬT KÝ ĐƠN BÁN HÀNG</h1>
        ...
        <div class="mt-5 row casumina-history">
            ...
            <div class="col-xl-9">
                ...
                <div id="sale-order-diary-table-container" data-url="{{ route('dealer.sale-order-diary') }}">
                    @include('dealer.layout.sale-order._table-order')
                </div>
            </div>
        </div>
    </div>
@endsection
@push('scripts')
    <script src="{{ asset('dealer/js/sale-order/order-diary.js') }}"></script>
@endpush
