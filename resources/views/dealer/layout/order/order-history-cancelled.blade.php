...
@section('dealer_content')
    <div class="page-order container-xl container-fluid">
        ...
        <h1 class="font-hanzel fs-42 fw-400 mt-5">THEO DÕI ĐƠN HÀNG</h1>
            ...
            <div class="col-xl-9">
                <div class="btn-group mb-3">
                    ...
                    <ul class="dropdown-menu">
                        @foreach (\App\Helpers\DealerHelper::buyStatusWithRoute() as $route => $label)
                ...
                <div id="order-history-table-container" data-url="{{ route('dealer.order-history-cancelled') }}">
                    @include('dealer.layout.order._table-order-history')
                </div>
            </div>
        </div>
    </div>
@endsection
@push('scripts')
    <script src="{{ asset('dealer/js/order/order-history.js') }}"></script>
@endpush
