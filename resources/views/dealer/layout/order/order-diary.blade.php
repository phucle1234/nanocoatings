...
@section('dealer_content')
    <div class="page-order container-xl container-fluid">
        ...
        <h1 class="font-hanzel fs-42 fw-400 mt-5">SỔ NHẬT LÝ ĐƠN HÀNG</h1>
        ...
        <div class="mt-5 row order-history">
            ...
            <div class="col-xl-9">
                ...
                <div id="order-diary-table-container" data-url="{{ route('dealer.order-diary') }}">
                    @include('dealer.layout.order._table-order-diary')
                </div>
            </div>
        </div>
    </div>
@endsection
@push('scripts')
    <script src="{{ asset('dealer/js/order/order-diary.js') }}"></script>
@endpush
